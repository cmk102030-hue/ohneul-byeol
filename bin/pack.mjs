...
<dl class="guide">
  <dt>단정과 추정의 구분</dt>
  <dd>확실한 것은 단정으로 씁니다. 판단인 것은 <b>"~로 봅니다" · "~하기 쉽습니다"</b>로 씁니다. <b>문장의 어미가 곧 확신도입니다.</b> 모든 문장을 단정으로 쓰면 읽는 사람은 어느 것이 확실한지 구분할 수 없고, 그때부터 전부를 의심하게 됩니다. 지나간 대운을 다루는 <b>검증 구간</b>에는 네 단계(<span class="lv lv-확정">확정</span> <span class="lv lv-높음">높음</span> <span class="lv lv-중간">중간</span> <span class="lv lv-낮음">낮음</span>)를 표에 명시했습니다 — 채점의 기준이 되기 때문입니다.</dd>
  <dt>근거</dt>
  ...
  <dt>검증 구간</dt>
  <dd>지나간 대운에 대해 명식만으로 세운 예측과 채점란이 있습니다. <b>일부는 틀립니다.</b> 전부 맞히려면 진술이 넓어지고, 넓은 진술은 맞아도 의미가 없습니다. 틀린 항목이 있어야 맞은 항목이 신뢰를 갖습니다.</dd>
</dl>
</section>`;
